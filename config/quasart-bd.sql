...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f41d366d-91e5-11e9-8525-cecd028ee826:1-142350801';
...
CREATE TABLE `PREVIAS` (
  ...
  UNIQUE KEY `ID_FICHA_UNIQUE` (`ID_FICHA`),
...
-- Dump completed on 2024-09-10  0:30:16
