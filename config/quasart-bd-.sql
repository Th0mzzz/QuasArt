...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f41d366d-91e5-11e9-8525-cecd028ee826:1-143612543';
...
--
-- Table structure for table `DENUNCIAS_FICHAS`
--

DROP TABLE IF EXISTS `DENUNCIAS_FICHAS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `DENUNCIAS_FICHAS` (
  `ID_DENUNCIA` int(11) NOT NULL AUTO_INCREMENT,
  `USUARIOS_ID_USUARIO` int(11) NOT NULL,
  `FICHAS_ID_OBRA` int(11) NOT NULL,
  `DESCRICAO_DENUNCIA` varchar(120) NOT NULL,
  PRIMARY KEY (`ID_DENUNCIA`),
  KEY `ID_USUARIO_DENUNCIA_FICHA_idx` (`USUARIOS_ID_USUARIO`),
  KEY `ID_OBRA_DENUNCIA_FICHA_idx` (`FICHAS_ID_OBRA`),
  CONSTRAINT `ID_OBRA_DENUNCIA_FICHA` FOREIGN KEY (`FICHAS_ID_OBRA`) REFERENCES `FICHAS` (`ID_OBRA`),
  CONSTRAINT `ID_USUARIO_DENUNCIA_FICHA` FOREIGN KEY (`USUARIOS_ID_USUARIO`) REFERENCES `USUARIOS` (`ID_USUARIO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `DENUNCIAS_FICHAS`
--

LOCK TABLES `DENUNCIAS_FICHAS` WRITE;
/*!40000 ALTER TABLE `DENUNCIAS_FICHAS` DISABLE KEYS */;
/*!40000 ALTER TABLE `DENUNCIAS_FICHAS` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `DENUNCIAS_RESENHAS`
--

DROP TABLE IF EXISTS `DENUNCIAS_RESENHAS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `DENUNCIAS_RESENHAS` (
  `ID_DENUNCIA` int(11) NOT NULL AUTO_INCREMENT,
  `USUARIOS_ID_USUARIO` int(11) NOT NULL,
  `RESENHAS_ID_RESENHAS` int(11) NOT NULL,
  `DESCRICAO_DENUNCIA` varchar(120) NOT NULL,
  PRIMARY KEY (`ID_DENUNCIA`),
  KEY `ID_USUARIO_DENUNCIA_RESENHA_idx` (`USUARIOS_ID_USUARIO`),
  KEY `ID_RESENHA_DENUNCIA_idx` (`RESENHAS_ID_RESENHAS`),
  CONSTRAINT `ID_RESENHA_DENUNCIA` FOREIGN KEY (`RESENHAS_ID_RESENHAS`) REFERENCES `RESENHAS` (`ID_RESENHAS`),
  CONSTRAINT `ID_USUARIO_DENUNCIA_RESENHA` FOREIGN KEY (`USUARIOS_ID_USUARIO`) REFERENCES `USUARIOS` (`ID_USUARIO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `DENUNCIAS_RESENHAS`
--

LOCK TABLES `DENUNCIAS_RESENHAS` WRITE;
/*!40000 ALTER TABLE `DENUNCIAS_RESENHAS` DISABLE KEYS */;
/*!40000 ALTER TABLE `DENUNCIAS_RESENHAS` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `DENUNCIAS_USUARIOS` (
  ...
  KEY `ID_DENUNCIADO_idx` (`ID_DENUNCIADO`),
  CONSTRAINT `ID_DENUNCIADO` FOREIGN KEY (`ID_DENUNCIADO`) REFERENCES `USUARIOS` (`ID_USUARIO`),
...
--
-- Table structure for table `DENUNCIAS_VIDEOS`
--

DROP TABLE IF EXISTS `DENUNCIAS_VIDEOS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `DENUNCIAS_VIDEOS` (
  ...
  PRIMARY KEY (`ID_DENUNCIA`),
  KEY `ID_USUARIO_idx` (`USUARIOS_ID_USUARIO`),
  KEY `ID_VIDEO_idx` (`VIDEOS_ID_VIDEOS`),
  CONSTRAINT `ID_USUARIO_DENUNCIA_VIDEO` FOREIGN KEY (`USUARIOS_ID_USUARIO`) REFERENCES `USUARIOS` (`ID_USUARIO`),
  CONSTRAINT `ID_VIDEO_DENUNCIA_VIDEO` FOREIGN KEY (`VIDEOS_ID_VIDEOS`) REFERENCES `VIDEOS` (`ID_VIDEOS`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `DENUNCIAS_VIDEOS`
--

LOCK TABLES `DENUNCIAS_VIDEOS` WRITE;
/*!40000 ALTER TABLE `DENUNCIAS_VIDEOS` DISABLE KEYS */;
/*!40000 ALTER TABLE `DENUNCIAS_VIDEOS` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `FAVORITO_FICHAS` VALUES (2,40,36),(5,40,71),(6,41,37);
...
INSERT INTO `FAVORITO_RESENHAS` VALUES (4,24,36),(5,24,71);
...
INSERT INTO `FAVORITO_VIDEOS` VALUES (9,71,4),(10,37,4),(11,36,4),(12,69,4);
...
CREATE TABLE `RESENHAS` (
  ...
  `HASHTAG_RESENHA` varchar(1000) NOT NULL,
  `NOTA_RESENHA` decimal(5,0) DEFAULT NULL,
  `CAPA_CAMINHO` varchar(30) NOT NULL,
  `CATEGORIA_ID_CATEGORIA` int(11) DEFAULT NULL,
  `USUARIOS_ID_USUARIO` int(11) NOT NULL,
...
-- Dump completed on 2024-10-17 16:56:13
